...
- Si mencionas que vas a sugerir carreras, ${shouldGiveFullResponse
            ...
            try {
                res.json({
                    ...
                    counselor: {
                        ...
                        description: "Experta en psicología vocacional con décadas de experiencia ayudando a personas a descubrir su verdadera vocación",
                        services: [
...
Recuerda: Eres una guía experta que ${isFullResponse
            ? "ayuda a las personas a descubrir su vocación auténtica con orientación detallada"
            : "intriga sobre las posibilidades vocacionales que has identificado"}. Tu objetivo es empoderar, no decidir por ellos. ${isFullResponse
