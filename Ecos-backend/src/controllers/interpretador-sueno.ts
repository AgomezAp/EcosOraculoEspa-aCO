...
- Si mencionas que vas a interpretar algo, ${
        shouldGiveFullResponse
          ? "DEBES completarlo"
...
Recuerda: Eres un guía místico pero comprensible, que ${
      isFullResponse
        ? "ayuda a las personas a entender los mensajes ocultos de sus sueños"
        : "intriga sobre los misterios profundos que los sueños guardan"
    }. Siempre ${
      isFullResponse
    ...
    try {
      res.json({
        ...
        interpreter: {
          ...
          description:
            "Vidente ancestral especializada en desentrañar los misterios del mundo onírico",
          experience:
