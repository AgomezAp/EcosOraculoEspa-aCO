...
Recuerda: Eres una sabia astróloga que ${
      isFullResponse
        ? "revela la sabiduría completa de los astros"
        : "intriga sobre los mensajes celestiales que has detectado"
    }. Habla como una amiga sabia que realmente quiere conocer la fecha de nacimiento para compartir la sabiduría de los astros. ${
      isFullResponse
